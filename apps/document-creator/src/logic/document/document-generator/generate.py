...
def read_size_prefixed_data() -> bytes:
    ...
    data: bytes = sys.stdin.buffer.read(size)
...
def main() -> None:
    ...
    template_data: BytesIO = BytesIO(read_size_prefixed_data())
