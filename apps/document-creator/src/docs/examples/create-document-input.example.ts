...
const londonBoundary: FeatureCollection<Geometry, { style: PathOptions }> = {
...
const parisBoundary: FeatureCollection<Geometry, { style: PathOptions }> = {
  type: 'FeatureCollection',
  features: [
    {
      type: 'Feature',
...
const newYorkBoundary: FeatureCollection<Geometry, { style: PathOptions }> = {
  type: 'FeatureCollection',
  features: [
    {
      type: 'Feature',
