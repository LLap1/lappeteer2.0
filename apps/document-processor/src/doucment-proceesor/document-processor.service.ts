...
import type { GenerateDocumentInput, GenerateDocumentOuput } from '../app.router.schema';
import type { AnalyzeTemplateParamsInput, AnalyzeTemplateParamsOutput } from '../app.router.schema';
...
export class DocumentProcessorService {
  ...
  async generate(input: GenerateDocumentInput): Promise<GenerateDocumentOuput> {
    ...
    const templateBuffer = await input.template.arrayBuffer();
    try {
