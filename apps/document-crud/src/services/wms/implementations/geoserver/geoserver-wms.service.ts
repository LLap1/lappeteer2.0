...
import { BuildWmsUrlInput, type GetMapInput } from '../../wms.model';
...
export class GeoserverWmsService extends WmsService {
  ...
  protected buildWmsUrl(input: BuildWmsUrlInput): string {
    const { overlayId, streamingUrl, bbox, width, height, format = 'png' } = input;
